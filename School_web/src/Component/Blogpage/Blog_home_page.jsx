    ...
    <div className="min-h-screen bg-gray-50">
      <main className="container mx-auto px-4 py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {blogPosts.map((post) => (
            ...
            >
              ...
              <div className="p-6">
                <h2 className="text-xl font-bold text-gray-900 mb-2 hover:text-blue-600 transition duration-300">
        ...
        <div className="text-center mt-12">
          <button className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-full font-medium transition duration-300 cursor-pointer whitespace-nowrap !rounded-button">
            Load More Articles
          </button>
        </div>
      </main>
...
//                 setLoading(false);
//               }}
//               className="bg-blue-600 hover:bg-blue-700 text-white px-8 py-3 rounded-full font-medium transition duration-300 cursor-pointer whitespace-nowrap !rounded-button flex items-center justify-center gap-2 mx-auto"
//               disabled={loading}
//             >
//               {loading ? (
//                 <>
