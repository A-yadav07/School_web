...
const AboutPage = () => {
  return (
    <div className="bg-gray-100 text-gray-900">
      {/* Hero Section */}
      <div className="relative h-50 flex items-center justify-center bg-cover bg-center" style={{ backgroundImage: "url('https://source.unsplash.com/1600x900/?university,students')" }}>
        <div className="absolute inset-18 bg-black bg-opacity-50"></div>
      ...
      <div className="bg-white py-12">
        <div className="max-w-5xl mx-auto px-6 grid md:grid-cols-2 gap-8">
          <div className="bg-gray-200 p-6 rounded-lg shadow">
            ...
            <p className="text-gray-700">To nurture students with the best educational resources, ensuring academic and personal growth.</p>
          </div>
          <div className="bg-gray-200 p-6 rounded-lg shadow">
            <h3 className="text-2xl font-semibold mb-3">Our Vision</h3>
            <p className="text-gray-700">To be a globally recognized institution that excels in innovation, research, and community service.</p>
          </div>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-3 gap-6">
          {[1, 2, 3].map((index) => (
            <div key={index} className="bg-white p-6 rounded-lg shadow text-center">
              <img src={`https://source.unsplash.com/150x150/?person,${index}`} alt="Faculty" className="mx-auto rounded-full mb-4" />
