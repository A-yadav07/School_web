  ...
  return (
    <section className="text-center py-20 px-4 bg-white">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
        <button className="flex items-center gap-1 bg-white border border-blue-600 text-blue-600 hover:bg-blue-50 font-medium px-6 py-2 rounded-full text-sm transition">
          <span className="text-xs">👁</span> Preview Pro Figma
        </button>
        <button className="flex items-center gap-1 bg-blue-600 hover:bg-blue-700 text-white font-medium px-6 py-2 rounded-full text-sm transition">
          ⭳ Free Figma
        </button>
      </div>
    </section>
